<style type="text/css">
  .btnprover {
      background: linear-gradient(to bottom, #3cb0fd, #3230BF) repeat scroll 0 0 #3cb0fd;
      border-radius: 3px;
      color: #ffffff;
      font-family: Georgia;
      font-size: 15px;
...
<div class="wrapper">
  <div class="wrap" style="float:left; width:100%;">
    ...
    <div style="width:70%;float:left;"><h2>Wordpress Booking Manager Pro</h2></div>
       <div class="main_div">
        <div class="metabox-holder" style="width:98%; float:left;">
            <div id="namediv" class="stuffbox" style="width:60%;min-height:450px;">
              ...
              <div style="padding-top:15px;margin-left:20px;">
                <a class="btnprover" target="_blank" href="http://upscalethought.com/products/booking/" style="width:150px;height: 20px;background-color: #3230BF;color:white;" >Wordpress Booking Manager Pro</a>
              </div>  
               <form id="frmCssFix" action="" method="post" style="width:100%">
                 <div style="margin: 20px;">
                   ...
                   <div style="padding-top:15px;">
                     <b>Please Have Our Professional Version to get full features</b><br/><br/><br/>
                     <a class="btnprover" target="_blank" href="http://upscalethought.com/products/booking/" style="width:150px;height: 20px;background-color: #3230BF;color:white;" >Wordpress Booking Manager Pro</a>
                    </div>
